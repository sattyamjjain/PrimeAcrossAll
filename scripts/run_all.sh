...
run_language "Prolog" "swipl -q -f languages/prolog/prime.pl"
...
run_language "Clojure" "clj -M languages/clojure/prime.clj <<< $NUMBER"
...
run_language "MATLAB" "octave --eval \"prime_check($NUMBER)\" <<< $NUMBER"
...
run_language "Q#" "dotnet run --project languages/qsharp/prime.qs <<< $NUMBER"
